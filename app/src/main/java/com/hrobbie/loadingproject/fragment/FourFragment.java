...
public class FourFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        Log.e("TAG", "FourFragment onViewCreated");
    ...
    public void onStart() {
        super.onStart();
        Log.e("TAG", "FourFragment onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.e("TAG", "FourFragment onResume");
    }
    ...
    protected void lazyLoad() {
        ...
        if(mHasLoadedOnce){
            ...
            Log.e("TAG", "FourFragment loaddata");
